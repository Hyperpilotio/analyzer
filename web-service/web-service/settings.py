"""
Django settings for web-service project.
...
SECRET_KEY = '4#ebd*8*-1*_3cqyx-16b%uc!em+t^itwlo8yd!d**9ohof%9@'
...
WSGI_APPLICATION = 'web-service.wsgi.application'
