...
# get all apps
echo "get all apps: "
curl -s -XGET localhost:5000/api/apps | jq -c .
...
echo "get app state"
curl -s   -H "Content-Type: application/json" -X GET  http://127.0.0.1:5000/api/apps/${APP_ID}/state | jq -c .
echo "update app state to Unregistered"
curl -s -X PUT -d '{"state":"Unregistered"}' -H "Content-Type: application/json"  http://127.0.0.1:5000/api/apps/${APP_ID}/state | jq -c .
...
curl -s  -H "Content-Type: application/json" -X GET  http://127.0.0.1:5000/api/apps/${APP_ID}/slo | jq -c .

# get un-exist slo by name
echo "get slo BEFORE SLO created by name: should be error too"
curl -s  -H "Content-Type: application/json" -X GET  http://127.0.0.1:5000/api/apps/info/${APP_NAME}/slo | jq -c .

# update un-exist slo
echo "update slo before SLO created: should be error too"
curl -s -X PUT -d @workloads/new_slo.json  -H "Content-Type: application/json"  http://127.0.0.1:5000/api/apps/${APP_ID}/slo | jq -c .


# add app slo
echo "add new slo: return whole application.json"
curl -s -X POST -d @workloads/app-slo.json  -H "Content-Type: application/json"  http://127.0.0.1:5000/api/apps/${APP_ID}/slo | jq -c .
...
curl -s -X GET -d '{"app":"tech-demo"}' -H  "Content-Type: application/json"  localhost:5000/api/incidents | jq -c .
echo "incidents is not added: should be error"
curl -s -X GET -d '{"app_name":"tech-demo"}' -H  "Content-Type: application/json"  localhost:5000/api/incidents | jq -c .
...
curl -s -X GET    localhost:5000/api/apps/${APP_ID}/management_features | jq -c .
echo "get invalid feature: should be error"
curl -s -X GET  localhost:5000/api/apps/${APP_ID}/management_features/efficiency | jq -c .
echo "get not exist efficiency_management: should be error"
curl -s -X GET  localhost:5000/api/apps/${APP_ID}/management_features/efficiency_management | jq -c .
echo "get bottleneck_management"
curl -s -X GET  localhost:5000/api/apps/${APP_ID}/management_features/bottleneck_management | jq -c .
echo "get interference_management"
curl -s -X GET  localhost:5000/api/apps/${APP_ID}/management_features/interference_management | jq -c .
...
curl -s -X PUT -d '{"status":"good"}' -H  "Content-Type: application/json"  localhost:5000/api/apps/${APP_ID}/management_features/efficiency_management | jq -c .
echo "new & old feature are not the same type : should be error"
curl -s -X PUT -d @workloads/bottleneck_management_feature.json  -H  "Content-Type: application/json"  localhost:5000/api/apps/${APP_ID}/management_features/efficiency_management | jq -c .
echo "append efficiency_management"
curl -s -X PUT -d @workloads/efficiency_management_feature.json  -H  "Content-Type: application/json"  localhost:5000/api/apps/${APP_ID}/management_features/efficiency_management | jq -c .
echo "update bottleneck_management"
curl -s -X PUT -d @workloads/bottleneck_management_feature.json  -H  "Content-Type: application/json"  localhost:5000/api/apps/${APP_ID}/management_features/bottleneck_management | jq -c .
echo "update interference_management"
curl -s -X PUT -d @workloads/interference_management_feature.json -H  "Content-Type: application/json"  localhost:5000/api/apps/${APP_ID}/management_features/interference_management | jq -c .
